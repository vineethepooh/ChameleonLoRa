...
This library monitors the RSSI (Received Signal Strength Indicator) of every incoming packet. If the signal strength falls below a defined threshold, the library automatically triggers a frequency shift to a secondary "clear" channel, ensuring your communication link remains robust.
